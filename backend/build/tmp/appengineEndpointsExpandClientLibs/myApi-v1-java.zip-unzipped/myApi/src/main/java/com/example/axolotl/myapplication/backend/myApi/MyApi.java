 ...
 * on 2016-05-24 at 14:08:29 UTC 
 * Modify at your own risk.
 */

package com.example.axolotl.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetJoke extends MyApiRequest<com.example.axolotl.myapplication.backend.myApi.model.Joker> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.axolotl.myapplication.backend.myApi.model.Joker.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.axolotl.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.axolotl.myapplication.backend.myApi.model.MyBean.class);
